-- ============================================================
-- SQL Setup Script - نظام إدارة وكيل دهانات الحرمين
-- الإصدار: 1.0
-- ============================================================
-- كيفية الاستخدام:
...
-- جدول المحفظة الإلكترونية (فودافون كاش المكتب)
...
-- جدول إعدادات التطبيق (للمزامنة عبر الأجهزة)
...
-- جدول سجل الحركات المركزي (يسجل حركات جميع المستخدمين من كل الأجهزة)
...
-- REPLICA IDENTITY FULL مطلوب لكي يعمل Supabase Realtime مع RLS بشكل صحيح
-- بدون هذا الإعداد، أحداث DELETE لا تُرسَل للعملاء عند تفعيل RLS
...
-- سياسة جدول users: قراءة لجميع المستخدمين، كتابة مفتوحة لمدير النظام
...
-- سياسة سجل الحركات: جميع المستخدمين المصادق عليهم يمكنهم القراءة والكتابة
...
-- ترقية: إضافة الأعمدة الجديدة إن لم تكن موجودة (آمن للتشغيل على قاعدة بيانات حالية)
...
-- ترقية: إضافة الأعمدة المطلوبة في الجداول الرئيسية (آمن للتشغيل مرات متعددة)
...
ALTER TABLE invoices      ADD COLUMN IF NOT EXISTS edited_by      TEXT;
ALTER TABLE invoices      ADD COLUMN IF NOT EXISTS edited_at      TIMESTAMPTZ;
ALTER TABLE invoices      ADD COLUMN IF NOT EXISTS delivery_status TEXT DEFAULT 'delivered' CHECK (delivery_status IN ('delivered','in_progress'));
...
ALTER TABLE invoice_items ADD COLUMN IF NOT EXISTS factory_price  DECIMAL(15,2) DEFAULT 0;
...
-- إدراج الأدوار الأساسية المحمية (admin, manager, sales, collector)
...
-- مدير النظام: صلاحيات كاملة على كل الصفحات
...
-- ==============================
-- الجزء السادس: بيانات تجريبية واقعية
-- ==============================

-- ملاحظة: هذه البيانات تجريبية تُمثّل بيانات تشغيلية حقيقية.
-- يمكن تعديلها أو حذفها بعد الاطلاع على طريقة عمل النظام.

-- ---- 6.1 المستخدمون ----
-- ملاحظة مهمة: كلمات المرور يجب إدخالها عبر Supabase Authentication → Users
--              هذا الجدول يحتفظ فقط بمعلومات الملف الشخصي والصلاحيات.
...
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000001', 'INV-20250110-0001', '2025-01-10',
   'c1000001-0000-0000-0000-000000000001', 'مقاولات النيل',
   'أحمد المندوب', 3850.00, 192.50, 3657.50, 3150.00, '', 'أحمد المندوب', 'active', '2025-01-10 09:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000001', 'e1000001-0000-0000-0000-000000000001',
   'd1000001-0000-0000-0000-000000000001', 'دهان خارجي ممتاز', 'لتر', 40, 55.00, 5.00, 2090.00),
  ('f1000001-0000-0000-0000-000000000002', 'e1000001-0000-0000-0000-000000000001',
   'd1000001-0000-0000-0000-000000000008', 'برايمر',            'لتر', 75, 24.00, 0.00, 1800.00);

-- فاتورة 2
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000002', 'INV-20250115-0002', '2025-01-15',
   'c1000001-0000-0000-0000-000000000002', 'محمد أحمد للمقاولات',
   'محمود السيد', 4760.00, 0.00, 4760.00, 3920.00, '', 'محمود السيد', 'active', '2025-01-15 10:30:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000003', 'e1000001-0000-0000-0000-000000000002',
   'd1000001-0000-0000-0000-000000000003', 'دهان داخلي ممتاز', 'لتر', 60, 43.00, 0.00, 2580.00),
  ('f1000001-0000-0000-0000-000000000004', 'e1000001-0000-0000-0000-000000000002',
   'd1000001-0000-0000-0000-000000000006', 'بلاستيك ملون',      'لتر', 44, 50.00, 0.00, 2200.00);

-- فاتورة 3
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000003', 'INV-20250120-0003', '2025-01-20',
   'c1000001-0000-0000-0000-000000000003', 'شركة البناء الحديث',
   'أحمد المندوب', 7875.00, 787.50, 7087.50, 6375.00, 'عميل VIP خصم 10%', 'أحمد المندوب', 'active', '2025-01-20 11:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000005', 'e1000001-0000-0000-0000-000000000003',
   'd1000001-0000-0000-0000-000000000001', 'دهان خارجي ممتاز', 'لتر', 50, 55.00, 10.00, 2475.00),
  ('f1000001-0000-0000-0000-000000000006', 'e1000001-0000-0000-0000-000000000003',
   'd1000001-0000-0000-0000-000000000007', 'ديكوري تكسير',      'كجم', 30, 105.00,10.00, 2835.00),
  ('f1000001-0000-0000-0000-000000000007', 'e1000001-0000-0000-0000-000000000003',
   'd1000001-0000-0000-0000-000000000005', 'بوية زيتية أبيض',   'كجم', 25, 75.00, 10.00, 1687.50);

-- فاتورة 4
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000004', 'INV-20250201-0004', '2025-02-01',
   'c1000001-0000-0000-0000-000000000004', 'مؤسسة الإعمار',
   'محمود السيد', 2700.00, 0.00, 2700.00, 2200.00, '', 'محمود السيد', 'active', '2025-02-01 09:30:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000008', 'e1000001-0000-0000-0000-000000000004',
   'd1000001-0000-0000-0000-000000000004', 'دهان داخلي عادي',  'لتر', 50, 28.00, 0.00, 1400.00),
  ('f1000001-0000-0000-0000-000000000009', 'e1000001-0000-0000-0000-000000000004',
   'd1000001-0000-0000-0000-000000000002', 'دهان خارجي عادي',  'لتر', 35, 38.00, 0.00, 1330.00);

-- فاتورة 5
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000005', 'INV-20250210-0005', '2025-02-10',
   'c1000001-0000-0000-0000-000000000005', 'علي حسن للدهانات',
   'أحمد المندوب', 5040.00, 403.20, 4636.80, 4200.00, '', 'أحمد المندوب', 'active', '2025-02-10 10:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000010', 'e1000001-0000-0000-0000-000000000005',
   'd1000001-0000-0000-0000-000000000010', 'مينا بلاستيك',      'لتر', 42, 60.00, 8.00, 2318.40),
  ('f1000001-0000-0000-0000-000000000011', 'e1000001-0000-0000-0000-000000000005',
   'd1000001-0000-0000-0000-000000000009', 'انشائي واجهات',      'كجم', 60, 26.00, 8.00, 1435.20),
  ('f1000001-0000-0000-0000-000000000012', 'e1000001-0000-0000-0000-000000000005',
   'd1000001-0000-0000-0000-000000000008', 'برايمر',             'لتر', 38, 24.00, 8.00,  883.20);

-- فاتورة 6
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000006', 'INV-20250218-0006', '2025-02-18',
   'c1000001-0000-0000-0000-000000000007', 'مقاولات الدلتا',
   'محمود السيد', 3420.00, 0.00, 3420.00, 2800.00, '', 'محمود السيد', 'active', '2025-02-18 08:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000013', 'e1000001-0000-0000-0000-000000000006',
   'd1000001-0000-0000-0000-000000000002', 'دهان خارجي عادي',  'لتر', 45, 38.00, 0.00, 1710.00),
  ('f1000001-0000-0000-0000-000000000014', 'e1000001-0000-0000-0000-000000000006',
   'd1000001-0000-0000-0000-000000000011', 'طلاء مائي أبيض',   'لتر', 54, 32.00, 0.00, 1728.00);

-- فاتورة 7
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000007', 'INV-20250301-0007', '2025-03-01',
   'c1000001-0000-0000-0000-000000000001', 'مقاولات النيل',
   'أحمد المندوب', 6600.00, 330.00, 6270.00, 5400.00, 'طلبية كبيرة', 'أحمد المندوب', 'active', '2025-03-01 09:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000015', 'e1000001-0000-0000-0000-000000000007',
   'd1000001-0000-0000-0000-000000000001', 'دهان خارجي ممتاز', 'لتر', 60, 55.00, 5.00, 3135.00),
  ('f1000001-0000-0000-0000-000000000016', 'e1000001-0000-0000-0000-000000000007',
   'd1000001-0000-0000-0000-000000000003', 'دهان داخلي ممتاز', 'لتر', 60, 43.00, 5.00, 2451.00),
  ('f1000001-0000-0000-0000-000000000017', 'e1000001-0000-0000-0000-000000000007',
   'd1000001-0000-0000-0000-000000000008', 'برايمر',            'لتر', 30, 24.00, 5.00,  684.00);

-- فاتورة 8
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000008', 'INV-20250308-0008', '2025-03-08',
   'c1000001-0000-0000-0000-000000000008', 'أحمد فؤاد للبناء',
   'محمود السيد', 2250.00, 0.00, 2250.00, 1800.00, '', 'محمود السيد', 'active', '2025-03-08 11:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000018', 'e1000001-0000-0000-0000-000000000008',
   'd1000001-0000-0000-0000-000000000004', 'دهان داخلي عادي',  'لتر', 30, 28.00, 0.00,  840.00),
  ('f1000001-0000-0000-0000-000000000019', 'e1000001-0000-0000-0000-000000000008',
   'd1000001-0000-0000-0000-000000000006', 'بلاستيك ملون',      'لتر', 20, 50.00, 0.00, 1000.00),
  ('f1000001-0000-0000-0000-000000000020', 'e1000001-0000-0000-0000-000000000008',
   'd1000001-0000-0000-0000-000000000008', 'برايمر',            'لتر', 17, 24.00, 0.00,  408.00);

-- فاتورة 9
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000009', 'INV-20250315-0009', '2025-03-15',
   'c1000001-0000-0000-0000-000000000009', 'شركة النور للمقاولات',
   'أحمد المندوب', 4320.00, 129.60, 4190.40, 3540.00, '', 'أحمد المندوب', 'active', '2025-03-15 09:30:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000021', 'e1000001-0000-0000-0000-000000000009',
   'd1000001-0000-0000-0000-000000000001', 'دهان خارجي ممتاز', 'لتر', 40, 55.00, 3.00, 2134.00),
  ('f1000001-0000-0000-0000-000000000022', 'e1000001-0000-0000-0000-000000000009',
   'd1000001-0000-0000-0000-000000000009', 'انشائي واجهات',     'كجم', 80, 26.00, 3.00, 2017.60);

-- فاتورة 10
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000010', 'INV-20250320-0010', '2025-03-20',
   'c1000001-0000-0000-0000-000000000010', 'مصطفى كمال للدهانات',
   'محمود السيد', 3900.00, 0.00, 3900.00, 3120.00, '', 'محمود السيد', 'active', '2025-03-20 10:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000023', 'e1000001-0000-0000-0000-000000000010',
   'd1000001-0000-0000-0000-000000000010', 'مينا بلاستيك',      'لتر', 35, 60.00, 0.00, 2100.00),
  ('f1000001-0000-0000-0000-000000000024', 'e1000001-0000-0000-0000-000000000010',
   'd1000001-0000-0000-0000-000000000012', 'دهان مضاد للصدأ',   'لتر', 26, 68.00, 0.00, 1768.00);

-- فاتورة 11 (ملغية - مثال)
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000011', 'INV-20250322-0011', '2025-03-22',
   'c1000001-0000-0000-0000-000000000002', 'محمد أحمد للمقاولات',
   'أحمد المندوب', 1520.00, 0.00, 1520.00, 1200.00, 'ملغية – خطأ في الكمية', 'أحمد المندوب', 'cancelled', '2025-03-22 08:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000025', 'e1000001-0000-0000-0000-000000000011',
   'd1000001-0000-0000-0000-000000000002', 'دهان خارجي عادي', 'لتر', 40, 38.00, 0.00, 1520.00);

-- فاتورة 12
INSERT INTO invoices (id, serial, date, customer_id, customer_name, sales_rep, gross_amount, discount_amount, net_amount, factory_amount, notes, created_by, status, created_at) VALUES
  ('e1000001-0000-0000-0000-000000000012', 'INV-20250324-0012', '2025-03-24',
   'c1000001-0000-0000-0000-000000000003', 'شركة البناء الحديث',
   'أحمد المندوب', 5250.00, 525.00, 4725.00, 4350.00, '', 'أحمد المندوب', 'active', '2025-03-24 09:00:00+00')
ON CONFLICT (serial) DO NOTHING;

INSERT INTO invoice_items (id, invoice_id, product_id, product_name, unit, qty, unit_price, discount, total) VALUES
  ('f1000001-0000-0000-0000-000000000026', 'e1000001-0000-0000-0000-000000000012',
   'd1000001-0000-0000-0000-000000000007', 'ديكوري تكسير',       'كجم', 25, 105.00, 10.00, 2362.50),
  ('f1000001-0000-0000-0000-000000000027', 'e1000001-0000-0000-0000-000000000012',
   'd1000001-0000-0000-0000-000000000001', 'دهان خارجي ممتاز',  'لتر', 50, 55.00,  10.00, 2475.00);
